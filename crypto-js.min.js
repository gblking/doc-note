!(function (t, e) {
  ...
  return (
              ...
              : (($ = (q = e1[L - 15]).high),
                ...
                (T =
                  (T =
                    ((($ >>> 1) | (J << 31)) ^ (($ >>> 8) | (J << 24)) ^ ($ >>> 7)) +
                    Z +
                    ((j = (Z = ((J >>> 1) | ($ << 31)) ^ ((J >>> 8) | ($ << 24)) ^ ((J >>> 7) | ($ << 25))) + q) >>> 0 <
                    Z >>> 0
                      ? 1
                      : 0)) +
                  (((G >>> 19) | (V << 13)) ^ ((G << 3) | (V >>> 29)) ^ (G >>> 6)) +
                  ((j += J = ((V >>> 19) | (G << 13)) ^ ((V << 3) | (G >>> 29)) ^ ((V >>> 6) | (G << 26))) >>> 0 <
                  J >>> 0
                    ? 1
                    : 0)),
                (j += $ = Q.low),
            ...
            var q = (F & W) ^ (~F & I),
              ...
              F =
                (R +
                  (N =
                    (N =
                      (N = N + q + (($ = $ + Z) >>> 0 < Z >>> 0 ? 1 : 0)) + Q + (($ = $ + Y) >>> 0 < Y >>> 0 ? 1 : 0)) +
                    T +
                    (($ = $ + j) >>> 0 < j >>> 0 ? 1 : 0)) +
                  ((P = (M + $) | 0) >>> 0 < M >>> 0 ? 1 : 0)) |
                0,
    ...
    (k = w.EvpKDF = F.extend({
      ...
      compute: function (t, e) {
        for (
          var r, i = this.cfg, n = i.hasher.create(), o = B.create(), s = o.words, c = i.keySize, a = i.iterations;
          s.length < c;
              ...
              for (var s = (this._invKeySchedule = []), c = 0; c < i; c++) {
                ...
                (a = c % 4 ? n[o] : n[o - 4]),
                  (s[c] =
                    c < 4 || o <= 4
                      ? a
                      : _[h[a >>> 24]] ^ y[h[(a >>> 16) & 255]] ^ v[h[(a >>> 8) & 255]] ^ g[h[255 & a]]);
              }
            }
          },
